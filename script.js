document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      const customMsg = field.getAttribute('data-error-' + rule);
      if (customMsg) return customMsg;

      const fieldLabel = field.labels && field.labels[0]
      ...
      const messages = {
        ...
        minlength: fieldLabel + ' must be at least ' + field.getAttribute('minlength') + ' characters.'
      };
    ...
    function validateField(field) {
      ...
      if (isValid && field.hasAttribute('minlength') && field.value.trim() !== '') {
        if (!VALIDATORS.minlength(field.value, field.getAttribute('minlength'))) {
          isValid = false;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7a4c6f51-e208-4592-983f-71988396af88',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7a4c6f51-e208-4592-983f-71988396af88';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7a4c6f51-e208-4592-983f-71988396af88';
